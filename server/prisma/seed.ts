...
async function main() {
  ...
  await prisma.studentPlacementHistory.deleteMany({});
  await prisma.driveStudent.deleteMany({});
  await prisma.studentDocument.deleteMany({});
  await prisma.studentAcademics.deleteMany({});
  await prisma.studentLinks.deleteMany({});
  await prisma.studentTermination.deleteMany({});
  ...
  console.log('Seeding administrative system users...');
  ...
  console.log('Clean initialization completed. System is 100% ready for dynamic Excel imports!');
}
